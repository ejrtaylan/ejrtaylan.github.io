  ...
  <div>
    ...
    <ul>
      ...
      <li>
        ...
        <a href="https://www.linkedin.com/in/ejrtaylan/" target="_blank">linkedin.com/ejrtaylan</a>
      </li>
      <li>
        <i class="fa fa-github fa-lg fa-fw"></i>
        <a href="https://github.com/ejrtaylan" target="_blank">github.com/ejrtaylan</a>
      </li>
      <li>
